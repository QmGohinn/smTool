...
#define BUTTON_CLICKED(BUTTON_NUM)												\
	void CFunnyModule_MFCDlg::OnBnClickedButton##BUTTON_NUM()		    \
	{																											\
...
#define	 _BIND_BUTTON_FUNC(BUTTON_NUM)								\
	...
	&CFunnyModule_MFCDlg::OnBnClickedButton##BUTTON_NUM)
...
class CFunnyModule_MFCDlg : public CDialogEx
{
// 构造
public:
	CFunnyModule_MFCDlg(CWnd* pParent = NULL);	// 标准构造函数

// 对话框数据
	enum { IDD = IDD_FUNNYMODULE_MFC_DIALOG };
