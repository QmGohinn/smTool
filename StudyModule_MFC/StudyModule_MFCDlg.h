...
#define BUTTON_CLICKED(BUTTON_NUM)												\
	void CStudyModule_MFCDlg::OnBnClickedButton##BUTTON_NUM()		    \
{																											\
...
#define	 _BIND_BUTTON_FUNC(BUTTON_NUM)								\
	...
	&CStudyModule_MFCDlg::OnBnClickedButton##BUTTON_NUM)
...
class CStudyModule_MFCDlg : public CDialogEx
{
// 构造
public:
	CStudyModule_MFCDlg(CWnd* pParent = NULL);	// 标准构造函数

// 对话框数据
	enum { IDD = IDD_STUDYMODULE_MFC_DIALOG };
